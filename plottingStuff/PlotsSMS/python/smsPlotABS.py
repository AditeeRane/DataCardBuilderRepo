...
class smsPlotABS(object):
	...
	#self.emptyHisto.GetXaxis().SetNdivisions(5,4,0)
        ...
        self.emptyHisto.GetYaxis().SetTitleOffset(1.4)
	...
	diagonal.SetPoint(diagonal.GetN(),0,0)
	diagonal.SetPoint(diagonal.GetN(),0,600)
	diagonal.SetPoint(diagonal.GetN(),1000,1000)
	diagonal.SetPoint(diagonal.GetN(),1000,0)
